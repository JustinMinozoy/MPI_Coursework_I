    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnResetPassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Sign_Up_Activity.this, Reset_Password_Activity.class));
            }
        });
                ...
                auth.createUserWithEmailAndPassword(email, password)
                        .addOnCompleteListener(Sign_Up_Activity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                Toast.makeText(Sign_Up_Activity.this, "createUserWithEmail:onComplete:" + task.isSuccessful(), Toast.LENGTH_SHORT).show();
